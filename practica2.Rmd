...
# ggplot(result_by_competition_season, aes(Season, NumMatches, label = Season)) +
#      geom_bar(stat="identity") +
#      facet_wrap(~Competition, scales="free")
# ggplot(result_by_competition_season, aes(x = Season, y = NumMatches, fill = FTR, label = Season)) +
#   facet_wrap(~Competition, scales="free") +
#   geom_bar(position = "fill", stat = "identity") +
#   labs(y = "Matches (%)", fill = "Result") +
...
Degut a l'impacte que se li atribueix als aficionats al rendiment dels equips tot i no participar directament en el joc, en aquest apartat s'analitzaran els resultats dels partits (victòria local/visitant o empat) segons múltiples variables, per poder comprovar si les restriccions d'aforament per la COVID-19 han pogut influir en els resultats dels partits.
